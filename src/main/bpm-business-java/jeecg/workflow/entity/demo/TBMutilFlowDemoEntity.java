 ...
 */
@Entity
@Table(name = "t_b_mutil_flow_demo", schema = "")
@SuppressWarnings("serial")
public class TBMutilFlowDemoEntity implements java.io.Serializable {
	/**主键*/
	...
	/**出差开始时间*/
	@Excel(name="出差开始时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date beginDate;
	/**出差结束时间*/
	@Excel(name="出差结束时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date endDate;
	/**出差事由*/
	@Excel(name="出差事由",width=15)
	private java.lang.String remarks;
	/**借款金额*/
	@Excel(name="借款金额",width=15)
	private java.math.BigDecimal borrowBalance;
	/**流程状态*/
	private java.lang.String bpmStatus;
	/**借款审批状态*/
	private java.lang.String borrowBpmStatus;
	...
	@Column(name ="BORROW_BALANCE",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  借款审批状态
	 */

	@Column(name ="BORROW_BPM_STATUS",nullable=true,length=32)
	public java.lang.String getBorrowBpmStatus(){
		return this.borrowBpmStatus;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  借款审批状态
	 */
	public void setBorrowBpmStatus(java.lang.String borrowBpmStatus){
		this.borrowBpmStatus = borrowBpmStatus;
	}
}
