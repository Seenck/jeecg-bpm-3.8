...
//update-beign-author:taoYan date:20180802 for:船舶首页菜单图标按钮和折叠控件位置切换不同步
if(opts.firstbuybuy == true){
	if(_2f6==0){
		opts.secondbuybuy.call(this,'expand');
	}
}
//update-end-author:taoYan date:20180802 for:船舶首页菜单图标按钮和折叠控件位置切换不同步
...
if(opts.firstbuybuy == true){
	if(_2f9==0){
		opts.secondbuybuy.call(this,'collapse');
	}
}
//update-end-author:taoYan date:20180802 for:船舶首页菜单图标按钮和折叠控件位置切换不同步
