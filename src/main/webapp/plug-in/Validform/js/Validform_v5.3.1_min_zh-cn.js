		...
		check : function(curform, brothers, subpost, bool) {
			...
			if(validType!=null){
			   ...
			   if (resultParams[1] == "false" && tipType == 1) {
                    ...
                    flag = false;
                    //update-start--Author:scott  --- Date:20180604 ----for：vue 采用validform校验，重复校验提交check不住问题----
                    this.validform_lastval = null;
                    //update-end--Author:scott  --- Date:20180604 ----for：vue 采用validform校验，重复校验提交check不住问题----
                    return false;
                }
