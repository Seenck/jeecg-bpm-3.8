...
$(function(){
	if(location.href.indexOf("load=detail")!=-1){
		...
		//update-end-author：jiaqiankun date:20180713 for:TASK #2969 【代码生成器--贾乾坤】代码生成器模板测试
	}
});
	...
	try{
		...
		//update--end--author:taoYan Date:20170628 for:default/shortcut提示用原风格---
			...
			layer.open({
				...
				shade:false,
				icon:icon,
				//update-begin-author:taoyan Date:20180706 for:tip框样式微调
				skin:'jz',
				//update-end--author:taoyan Date:20180706 for:tip框样式微调
				shift:2
			});
		}
		//update--begin--author:zhangjiaqiang Date:20170227 for:更新提示框
	...
	try{
		...
		if( navigator.appName != navigatorName ){ 
			if(obj.nodeName == 'IMG'){
				...
				//update-begin-author:taoyan date:20180725 for:TASK #3005 【bug】ERP风格，列表图片显示，遮挡的问题
				var curlayer;
				if(!level){
					curlayer = layer;
				}else if(level==1){
				...
				//update-end-author:taoyan date:20180725 for:TASK #3005 【bug】ERP风格，列表图片显示，遮挡的问题
