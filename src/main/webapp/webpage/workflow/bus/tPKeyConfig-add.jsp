...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPKeyConfigController.do?doAdd" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="sysCode" name="sysCode" type="text" style="width: 150px" class="inputxt"  datatype="*"/>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="signKey" name="signKey" type="text" style="width: 500px" class="inputxt"  datatype="*"/>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="encrypKey" name="encrypKey" type="text" style="width: 500px" class="inputxt" />
							<span class="Validform_checktip"></span>
