...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="historyProcessList" title="processes.i.created" autoLoadData="true" actionUrl="processInstanceController.do?historyProcessListDataGrid" sortName="userName" fitColumns="true" idField="id" fit="true" queryMode="group">
			<t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
			<t:dgCol title="标题" field="bpmBizTitle" width="150"></t:dgCol>
			<t:dgCol title="common.process.name" sortable="false" field="prcocessDefinitionName" width="100"></t:dgCol>
			<t:dgCol title="process.definition.id" sortable="false" field="processDefinitionId" width="100"></t:dgCol>
			...
			<t:dgFunOpt exp="endtime#eq#" funname="callBackProcess(processInstanceId,isSuspended)" title="return.process" urlclass="ace_button" urlfont="fa-exchange"></t:dgFunOpt>
			<%-- <t:dgFunOpt funname="viewHistory(processInstanceId)" title="common.history"></t:dgFunOpt>--%>
			<t:dgFunOpt funname="goProcessHisTab(processInstanceId,undefined)" title="common.history" urlclass="ace_button" urlStyle="background-color:#FF6347" urlfont="fa fa-history"></t:dgFunOpt>
		</t:datagrid>
	</div>
</div>
