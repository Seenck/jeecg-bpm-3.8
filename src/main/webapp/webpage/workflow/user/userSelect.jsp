...
<div class="easyui-layout" style="width:1000px;height:600px;">
    ...
    <div data-options="region:'center'">
        <t:datagrid checkbox="true" name="userList1" title="common.user.select" actionUrl="tSUserAgentController.do?userdatagrid"
                    fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate" sortOrder="desc" singleSelect="true">
