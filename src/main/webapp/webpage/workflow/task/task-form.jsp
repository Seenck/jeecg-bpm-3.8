...
<div id="panelloadingDiv" class="panel-loading" style="width:100%">加载中....</div>
<c:if test="${not empty nodeStart }">
<iframe id="taskformiframe" src="${nodeStart}" width="100%" height="100%" FRAMEBORDER=0 onload="hiddenloading();"></iframe>
</c:if>
