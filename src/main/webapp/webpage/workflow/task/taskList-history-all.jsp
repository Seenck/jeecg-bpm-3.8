...
<t:datagrid fitColumns="true" name="historyTaskList" queryMode="group" title="common.task.history" actionUrl="taskController.do?taskAllHistoryList" idField="id">
 ...
 <t:dgFunOpt funname="goProcessHisTab(proInsl_procInstId,name)" title="common.history" urlclass="ace_button" urlStyle="background-color:#FF6347" urlfont="fa fa-history"></t:dgFunOpt>
 </t:datagrid>
