...
<script>
	 ...
	 */
		function openDepartmentSelect() {
			...
			//update-begin--Author:scott ---- date:20180723 ---- for：TASK #3003 【弹窗问题】弹出窗，第二层，第三层操作关闭的时候，会导致遮罩全部没了---
			$.dialog({
			...
			//update-end--Author:scott ---- date:20180723 ---- for：TASK #3003 【弹窗问题】弹出窗，第二层，第三层操作关闭的时候，会导致遮罩全部没了---
		}
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			<td align="right" width="25%" nowrap>
                <label class="Validform_label">  员工账号:  </label>
            </td>
		...
		<tr>
			<td align="right" width="10%" nowrap><label class="Validform_label"> 员工名称: </label></td>
