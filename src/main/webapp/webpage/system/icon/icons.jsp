...
<script type="text/javascript">
	$(function(){
		$("#formobj").submit(function(){
			...
			//update-begin-author:taoyan date:20180528 for:TASK #2737 【系统管理】系统图标--图标编辑---
			...
			//update-end-author:taoyan date:20180528 for:TASK #2737 【系统管理】系统图标--图标编辑---
			if($.trim(file_upload) == ""){
				tip("请选择上载文件.");
				return false;
			}
...
<t:formvalid formid="formobj" layout="div" dialog="true" beforeSubmit="upload">
    ...
    <!-- update-begin--Author:gj_liucj  Date:20180428 for：TASK #2680 【页面优化】图标编辑页面优化-------------------- -->
    ...
    <!-- update-end--Author:gj_liucj  Date:20180428 for：TASK #2680 【页面优化】图标编辑页面优化-------------------- -->
	<div class="form">
	<div id="filediv"></div>
