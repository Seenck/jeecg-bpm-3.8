...
<body>
	<div class="easyui-layout" fit="true" scroll="no">
		<div  data-options="region:'west',title:'组织机构管理',split:true" style="width:200px;overflow: auto;">
...
function loadTree() {
	...
	/*jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'organzationController.do?getTreeData',//请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"","")
 			...
 			.setAsync({
                enable: true,
                url:"organzationController.do?getTreeData",
...
//添加供应商
function addSupplierNode() {
	closeAllTab();
	var url = "organzationController.do?toAddSupplier";
	addtt('添加供应商', url, '01','icon-search', 'false');
}
