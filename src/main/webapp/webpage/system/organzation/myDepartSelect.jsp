...
<script type="text/javascript">
	...
	function zTreeOnExpand(event, treeId, treeNode){
		 ...
		 $.post(
			'organzationController.do?getMyDepartInfo',
...
<%-- <t:datagrid name="departList" title="common.department.list" actionUrl="organzationController.do?departSelectDataGrid" idField="id" checkbox="true" showRefresh="false">
