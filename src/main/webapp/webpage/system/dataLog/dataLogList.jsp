...
<script>
	...
	function dataDiff(){
		...
		//--update--begin--author:gj_shaojc-- date:20180601--for：TASK #2738 【数据监控】 -- 数据日志 -- 数据比较版本信息获取BUG
		...
		//--update--end--author:gj_shaojc-- date:20180601--for：TASK #2738 【数据监控】 -- 数据日志 -- 数据比较版本信息获取BUG
