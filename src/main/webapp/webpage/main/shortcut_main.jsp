...
<SCRIPT type="text/javascript">
	...
	$(document).ready(function(){
		...
		//加载待办任务
		var taskurl = "taskController.do?getTaskCount";
		$.ajax({
    		url:taskurl,
    		type:"GET",
    		dataType:"JSON",
            ...
            <tr style="height: 25px;" align="right">
                <td style="" colspan="2">
                    ...
                    <div style="float: left; line-height: 25px; margin-left: 70px;">
                        ...
                        <span><img src="${webRoot}/plug-in/accordion/images/group_add.png"></span> 
                        <span style="color: #EE6B6B;cursor:pointer;" onclick="addOneTab('我的任务', 'taskController.do?goTaskListTab', 'default')">待办任务（<span id="taskCount">0</span>）</span>&nbsp;&nbsp;&nbsp;&nbsp;
