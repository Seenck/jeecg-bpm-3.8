...
<body style="overflow-y:hidden;">
	<div class="layout-admin">
		...
		<header class="layout-header">
			...
			<li class="header-bar-nav hiddenty-xs"> 
				<a href="javascript:addOneTab('我的任务', 'taskController.do?goTaskListTab', 'default');" title="待办">
					<i class="fa fa-bell"></i> 待办(<span id="taskCount">0</span>)
				</a>
			</li> 
	...
	$(function(){
		...
		//update-begin--Author:zhoujf Date:20180727 for：待办提醒 
      	//加载待办任务
		...
		//update-end--Author:zhoujf Date:20180727 for：待办提醒 
