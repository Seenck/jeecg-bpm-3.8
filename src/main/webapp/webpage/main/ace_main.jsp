					...
					<!-- 
						...
						<li class="grey">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								...
								<span class="badge badge-important" id="taskCount">0</span>
							</a>

							<ul class="pull-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
								<li class="dropdown-header" id="taskTip">
								...
								<li>
									<a href="#" id="taskContent">
									</a>
								</li>

								<li>
									<a href="javascript:addOneTab('我的任务', 'taskController.do?goTaskListTab', 'default');" id="taskFooter">
										查看待办任务
										<i class="icon-arrow-right"></i>
									</a>
								</li>
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<!-- update-begin-author:taoYan date:20180807 for: TASK #3052 【bug】论坛反馈 -- 3.8页面布局受到影响-->
					<ul class="nav nav-list" id="aceMainPageMenu" style="overflow-y:auto">
					<!-- update-end-author:taoYan date:20180807 for: TASK #3052 【bug】论坛反馈 -- 3.8页面布局受到影响-->
						<li class="active">
		...
		jQuery.ajax({
    		...
    		success:function(data){
    			if(data.success){
    				...
    				//加载待办任务提示
    				var taskTip = "";
    				taskTip += "<i class='icon-warning-sign'></i>";
    				taskTip += taskCount+"条待办任务";
    				$("#taskTip").html(taskTip);
