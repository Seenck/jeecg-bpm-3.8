...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgDemoList" checkbox="true" sortName="birthday,name" pagination="true" fitColumns="false" title="jeecg_demo" 
    ...
    <!--update begin author: liusq date:20180709 for:[TASK #2940 ] 给列表前几列添加frozenColumn属性  -->
    ...
    <!--update end author: liusq date:20180709 for:[TASK #2940 ] 给列表前几列添加frozenColumn属性  -->
