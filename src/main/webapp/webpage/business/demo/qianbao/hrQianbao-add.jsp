...
<body>
<form role="form" id="formobj" action="hrQianbaoController.do?doAdd" name="formobj" method="post">
<input 	type="hidden" id="btn_sub" class="btn_sub"/>
<input  type="hidden" value="1" id="documentCategory" name="documentCategory" />
<input  type="hidden" value="1" id="bpmStatus" name="bpmStatus" />
<input  type="hidden" value="office" id="qianbaoDepartCode" name="qianbaoDepartCode" />
<input  type="hidden" value="中国华融资产管理股份有限公司（办公室）" id="qianbaoDepartName" name="qianbaoDepartName" />
<input  type="hidden" value="2015-04-23" id="qianbaoDate" name="qianbaoDate" />
<div class="wrapper">
    <div class="content">
        <div class="topbar">
        ...
        <div class="number">
            ...
            <li>办公室[</li>
            <li><input class="form-control" type="text" value="2015" id="qianbaoCodeYear" name="qianbaoCodeYear" /></li>
            <li>]</li>
            <li><input class="form-control" type="text" value="11" id="qianbaoCodeNum" name="qianbaoCodeNum"/></li>
            <li>号</li>
        </div>
        <div class="sign">
            <li>签</li>
        ...
        <!-- <div class="bottom-btn">
            <li><button class="btn btn-default" type="button">部门领导审核</button></li>
            <li><button class="btn btn-default" type="button">内部核稿</button></li>
            <li><button class="btn btn-default" type="button">删除签报</button></li>
