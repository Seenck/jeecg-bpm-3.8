...
<div class="wrapper">
    <div class="content">
        ...
        <div class="bottom-btn">
            <li><button class="btn btn-default" type="button" onclick="procPass('下一步','${taskId}',2,'exclusiveGateway1479794111286')">下一步</button></li>
            <li><button class="btn btn-default" type="button" onclick="procPass('退给拟稿人','${taskId}',2,'task1479785191605')">退给拟稿人</button></li>
        </div>
    </div>
</div>
