...
<div class="wrapper">
    <div class="content">
        ...
        <div class="bottom-btn">
            <li><button class="btn btn-default" type="button" onclick="procPass('下一步','${taskId}',1,'')">下一步</button></li>
            <!-- <li><button class="btn btn-default" type="button">部内转办</button></li> -->
            <li><button class="btn btn-default" type="button" onclick="reject('退给拟稿人','${taskId}','task1479785191605')">退给拟稿人</button></li>
        </div>
    </div>
</div>
