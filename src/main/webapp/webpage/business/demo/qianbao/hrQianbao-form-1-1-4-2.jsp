...
<div class="wrapper">
    <div class="content">
        ...
        <div class="bottom-btn">
            <li><button class="btn btn-default" type="button" onclick="complate()">完成会签</button></li>
            <li><button class="btn btn-default" type="button" onclick="transOtherUser()">部内转办</button></li>
        </div>
    </div>
</div>
<script src = "plug-in/tools/workflow.js"></script>
		<script type="text/javascript">
			...
			function complate(){
				...
				if(assignee!="admin"){
					alert("该用户不是部门领导,不能完成会签");
					return;
				}
				procPass('会签完成','${taskId}',1,'')
			}
			...
			function transOtherUser(){
				...
				alert("办理人为"+user);
				selectEntrusterProcess('部内转办','${taskId}',user);
			}
		</script>
