    ...
    <div class="content">
        ...
        <div class="bottom-info">
            ...
            <div class="charge">
            	...
            	<li class="text-red">当前办理人：${assignee }</li>
                <li class="text-red">选择办理人：</li>
                <li><input class="form-control" type="text" id="selectUser" name="selectUser"/></li>
                <li class="btn-group"><button class="btn btn-default" type="button">选择</button></li>
            </div>
        </div>
        <div class="bottom-btn">
        	<%-- <li><button class="btn btn-default" type="button" onclick="procPass('会签完成','${taskId}',1,'')">会签完成</button></li> --%>
            <li><button class="btn btn-default" type="button" onclick="transOtherUser()">交办理人办理</button></li>
            <li><button class="btn btn-default" type="button" onclick="transLeader()">转部门领导</button></li> 
        </div>
    </div>
</div>
<script src = "plug-in/tools/workflow.js"></script>
		<script type="text/javascript">
			...
			function transLeader(){
				alert("获取的部门领为：admin");
				selectEntrusterProcess('转部门领导','${taskId}','admin');
			}
			
			function transOtherUser(){
				...
				alert("办理人为"+user);
				selectEntrusterProcess('转办理人','${taskId}',user);
			}
		</script>
