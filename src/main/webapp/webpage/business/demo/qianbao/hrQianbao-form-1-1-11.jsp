...
<div class="wrapper">
    <div class="content">
        ...
        <div class="bottom-btn">
            <li><button class="btn btn-default" type="button" onclick="procPass('下一步','${taskId}',1,'')" >完成签报</button></li>
            <%-- <li><button class="btn btn-default" type="button" onclick="selectEntrusterProcess('转部门领导','${taskId}','cw')">转部门领导</button></li> --%>
            <li><button class="btn btn-default" type="button">重新签批</button></li>
        </div>
    </div>
</div>
