...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid fit="true" name="joaFileInfoList" sortOrder="asc" sortName="ext" checkbox="true" pagination="true" fitColumns="true" title=""  actionUrl="joaFileInfoController.do?datagrid&dirId=${dirId}" idField="id" onDblClick="datagridDbclick" queryMode="single">
   ...
   <t:dgCol title="文件名称"  field="name" query="true" extendParams="editor:'text'" queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgDelOpt exp="ext#ne#0" title="删除" url="joaFileInfoController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   ...
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="joaFileInfoController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
  </t:datagrid>
