...
public class HttpUtils {
	...
	public static String doPostJson(String url, String jsonStr) {
		...
		try {
			...
			if (resEntity != null) {
				// String respBody = new
				// String(EntityUtils.toString(resEntity).getBytes("ISO_8859_1"),"GBK");
				// String respBody = new
				// String(EntityUtils.toString(resEntity,"UTF-8"));
	...
	public static String post(String url, Map<String, String> map) {
		...
		while (it.hasNext()) {
			Object key = it.next();
			formparams
					.add(new BasicNameValuePair(key.toString(), map.get(key)));
		}
		UrlEncodedFormEntity uefEntity;
		try {
			uefEntity = new UrlEncodedFormEntity(formparams, "UTF-8");
	...
	public static void main(String[] args) {
		...
		String content = HttpUtils.dogetJson(url);
