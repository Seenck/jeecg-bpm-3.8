...
<div class="easyui-layout" fit="true">
 ...
 <#-- update--begin--author:zhangjiaqiang date:20170531 for:增加图片和文件的列表判断 -->
  ...
  <#--//update-begin--Author:zhangjiaqiang  Date:20160925 for：TASK #1344 [链接图标] online功能测试的按钮链接图标修改 -->
   ...
   <#-- update--begin--author:zhoujf date:20171018 for:TASK 2303 【代码生成器】online代码生成后 流程提交按钮没有了 -->
   <#list columns as po>
   <#if po.fieldName == 'bpmStatus'>
   <t:dgFunOpt title="提交流程" exp="bpmStatus#eq#1"  funname="startProcess(id)" urlclass="ace_button"  urlfont="fa-trash-o"/>
   </#if>
   </#list> 
   <#-- update--end--author:zhoujf date:20171018 for:TASK 2303 【代码生成器】online代码生成后 流程提交按钮没有了 -->
  <#list buttons as btn>
