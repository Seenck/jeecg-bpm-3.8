...
public class TreeSelectTag extends TagSupport {
	...
	private void textInput(StringBuffer resultSb) {
		//update-begin-author:taoYan date:20180427 for:参照模板页面-标签改造---
		resultSb.append("<input type=\"text\" ");
		//update-end-author:taoYan date:20180427 for:参照模板页面-标签改造---
	...
	private void showTreeFunction(StringBuffer resultSb) {
		...
		//update-begin-author:taoYan date:20180427 for:标签改造-参照模板页面----
		...
		//update-end-author:taoYan date:20180427 for:标签改造-参照模板页面----
	...
	private void getCheckFunction(StringBuffer resultSb) {
		...
		//update-begin-author:zhoujf date:20180726 for:获取值多一个undefined问题----
		resultSb.append("if(nodes && nodes.length>0){for(var i = 0;i<nodes.length;i++){tempId+=nodes[i].id+',';tempText+=nodes[i].text+',';}}");    
		//update-end-author:zhoujf date:20180726 for:获取值多一个undefined问题----
