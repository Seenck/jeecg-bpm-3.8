...
//			update-start--Author:liushaoqian  Date:20180720 for：TASK #2970 【样式问题】div风格表单边框少一边
				sb.append("<div id=\"wrapper\" style=\"border-left:1px solid #ddd;\">");
//			update-end--Author:liushaoqian  Date:20180720 for：TASK #2970 【样式问题】div风格表单边框少一边
...
//			}
			...
			//update--begin---author:zhoujf date:20180801 for:TASK #3042 【validform标签】验证提示效果扩展
			if("6".equals(tiptype)){
			...
			//update--end---author:zhoujf date:20180801 for:TASK #3042 【validform标签】验证提示效果扩展
			if (usePlugin != null) {
...
//			sb.append("},");
			...
			if (beforeSubmit != null) {
				...
				//update-start--Author:yugwu  Date:20170912 for:beforeSubmit如果返回false页面遮罩层不消失问题----
			...
			sb.append("},");
			//update--end--author:zhangjiaqiang Date:20170424 for:修订页面加载数据
			//update-end--Author:yugwu  Date:20170912 for:beforeSubmit如果返回false页面遮罩层不消失问题----
			if (usePlugin != null) {
