...
//		log.setTSUser(ResourceUtil.getSessionUser());
	...
	public void refleshTypesCach(TSType type) {
		...
		//update-begin-author:taoYan date:20180627 for:HQL查询到的数据 作更改会把数据库里的数据更改掉，但是initAllTypeGroups方法里的就没有问题，不知道为什么--
		...
		//update-end-author:taoYan date:20180627 for:HQL查询到的数据 作更改会把数据库里的数据更改掉，但是initAllTypeGroups方法里的就没有问题，不知道为什么--
		//update-end--Author:taoyan  Date:20180621 for：字典增加排序--------------------
...
//        update-end--Author:zhangguoming  Date:20140901 for：修改编码长度的定义
	...
	public Set<String> getLoginDataRuleIdsByUserId(String userId,String functionId,String orgId) {
		...
		//update-begin-Author:LiShaoQing -- date:20180604 -- for:TASK #2749 【权限问题】增加组织机构角色授权数据权限的逻辑----
		...
		//update-end-Author:LiShaoQing -- date:20180604 -- for:TASK #2749 【权限问题】增加组织机构角色授权数据权限的逻辑----
	...
	public List<TSOperation> getLoginOperationsByUserId(String userId, String functionId, String orgId,String processnodeId) {
		...
		//update-begin-Author:LiShaoQing -- date:20180604 -- for:TASK #2749 【权限问题】增加组织机构角色授权页面权限的逻辑----
		...
		//update-end-Author:LiShaoQing -- date:20180604 -- for:TASK #2749 【权限问题】增加组织机构角色授权页面权限的逻辑----
		
		
		//-----【BPM逻辑】追加流程节点页面按钮权限---------------------------------------------------------------------------
		//TODO 拓展新的方法（查询未授权code）
