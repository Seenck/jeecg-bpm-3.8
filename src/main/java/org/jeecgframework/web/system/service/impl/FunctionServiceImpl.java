...
public class FunctionServiceImpl extends CommonServiceImpl implements FunctionService {
	...
	public AjaxJson delFunction(String functionId) {
		...
		try {
			//update-begin-Author:LiShaoQing -- date:20180806 -- for:TASK #3050 解决提示语存在国际化语言的时候进行转换---
			...
			//update-end-Author:LiShaoQing -- date:20180806 -- for:TASK #3050 解决提示语存在国际化语言的时候进行转换---
			if (parent != null) {
