...
public class SystemController extends BaseController {
	...
	//update-begin-author:taoYan date:20180801 for:字典数据信息获取支持获取字典表
	...
	//update-end-author:taoYan date:20180801 for:字典数据信息获取支持获取字典表
...
//	      update-start--Author:zhoujf  Date:20150615 for：组织机构管理编码规则生成
  ...
  //add-end--Author: taoyan  Date:20170405 for：文件上传通用跳转
	...
	//update-begin-author:taoYan date:20180726 for:TASK #3007 【新功能】陶炎的上传，不支持文档 swf转换
	/**
	 * WebUploader
	 * 文件上传处理/删除处理
	 */
	...
	//update-end-author:taoYan date:20180726 for:TASK #3007 【新功能】陶炎的上传，不支持文档 swf转换
	//update-begin--author:scott ---date:20180612 ----for:重构webUploadpath图片访问和下载服务接口，TASK #2059 【图片访问请求】每次请求很慢，需要实现缓存机制-----
//	/**
//	 * 获取图片流/获取文件用于下载
//	 * @param response
//	 * @param request
...
//		String flag=request.getParameter("down");//是否下载否则展示图片
//		String dbpath = request.getParameter("dbPath");
//		//update-begin author:taoYan date:20180517 for:路径结尾带逗号去除---
//		if(oConvertUtils.isNotEmpty(dbpath)&&dbpath.endsWith(",")){
//			dbpath = dbpath.substring(0, dbpath.length()-1);
//		}
//		//update-end author:taoYan date:20180517 for:路径结尾带逗号去除---
//		if("1".equals(flag)){
//			response.setContentType("application/x-msdownload;charset=utf-8");
//			String fileName=dbpath.substring(dbpath.lastIndexOf(File.separator)+1);
...
//	//update-begin-- author:gj_shaojc date:20180608 for:TASK #2760 【online表单】列表字段下载 文本乱码
	...
	//update-end--author:scott ---date:20180612 ----for:重构webUploadpath图片访问和下载服务接口，TASK #2059 【图片访问请求】每次请求很慢，需要实现缓存机制-----
