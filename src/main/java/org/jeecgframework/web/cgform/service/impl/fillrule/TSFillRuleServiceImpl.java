package org.jeecgframework.web.cgform.service.impl.fillrule;
...
@Service("tSFillRuleService")
@Transactional
public class TSFillRuleServiceImpl extends CommonServiceImpl implements TSFillRuleServiceI {
	...
	private void doDelBus(TSFillRuleEntity t) throws Exception{
 	...
 	private Map<String,Object> populationMap(TSFillRuleEntity t){
		...
		map.put("rule_code", t.getRuleCode());
		map.put("rule_name", t.getRuleName());
		map.put("rule_class", t.getRuleClass());
		map.put("rule_param", t.getRuleParam());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TSFillRuleEntity t){
 		...
 		sql  = sql.replace("#{rule_class}",String.valueOf(t.getRuleClass()));
 		sql  = sql.replace("#{rule_param}",String.valueOf(t.getRuleParam()));
