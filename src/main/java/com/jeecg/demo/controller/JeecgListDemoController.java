...
public class JeecgListDemoController extends BaseController {
	...
	//update-end--Author:gj_shaojc Date:20180305 for：TASK #2535 【开发】ECharts集成demo 
	...
	public void minidaoDatagrid(JeecgDemoEntity jeecgDemo,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//update-begin--Author:liushaoqian Date:20180718 for：TASK #2975 【论坛问题】minidao 列表，按照字段排序demo
		//设置排序字段
		...
		//update-end--Author:liushaoqian Date:20180718 for：TASK #2975 【论坛问题】minidao 列表，按照字段排序demo
...
//		dataGrid.setFooter("salary,age,name:合计");
	...
	//update-end--Author:LiShaoQing Date:20170915 for：TASK #2340 【demo】动态组查询Demo
	...
	public ModelAndView goBootStrapTableAdd(JeecgDemoEntity jeecgDemo, HttpServletRequest req) {
		...
		//update-begin-author:taoyan date：20180724 for:TASK #2994 【下拉输入框】demo---
		/**
		...
		//update-end-author:taoyan date：20180724 for:TASK #2994 【下拉输入框】demo---
}
